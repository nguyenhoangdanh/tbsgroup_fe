    ...
    <div className={cn('p-4 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg', className)}>
      <div className="flex justify-center items-center space-x-4">
        ...
        <div className="flex flex-col items-center">
          {!editMode ? (
            <>
              <Button variant="ghost" size="icon" onClick={() => adjustHours(1)} className="mb-2">
              ...
              <Button variant="ghost" size="icon" onClick={() => adjustHours(-1)} className="mt-2">
        ...
        <div className="flex flex-col items-center">
          {!editMode ? (
            <>
              <Button variant="ghost" size="icon" onClick={() => adjustMinutes(1)} className="mb-2">
                <ChevronUp className="h-4 w-4" />
              </Button>
              <div
                className="text-2xl font-bold w-12 text-center cursor-pointer"
