...
export type TableActions = 'create' | 'edit' | 'delete' | 'view';
...
export interface GroupingConfig {
  ...
  customGroupRenderer?: (group: any) => ReactNode;
  aggregations?: {
    field: string;
...
export interface ActionColumnConfig {
  ...
  width?: number | string;
  fixed?: 'left' | 'right';
  render?: (record: any, actions: ActionConfig[]) => ReactNode;
}
...
export interface EnhancedDataTableProps<T extends BaseTableData = BaseTableData> {
  // Essential props
  data: T[];
...
export interface DataTableProps<T extends BaseTableData = BaseTableData> extends EnhancedDataTableProps<T> {}