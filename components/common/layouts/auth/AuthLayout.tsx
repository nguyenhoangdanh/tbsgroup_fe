...
const _AuthLayout: React.FC<IAuthLayoutProps> = ({ title, imageChildren, isLogin, children }) => {
    return (
        <div className="w-full h-screen flex items-center justify-center px-4">
            <div className="w-full h-full flex items-center justify-center border-2 border-gray-200 rounded-lg max-h-[550px]
            max-w-[450px] bg-white shadow-lg overflow-hidden sm:max-w-[500px] md:max-w-[600px] lg:max-w-[700px] xl:max-w-[800px] 2xl:max-w-[900px]
