    ...
    <div className={cn('high-contrast-calendar rounded-lg', className)} style={styles}>
      <Calendar
        ...
        classNames={{
          ...
          day_selected:
            'bg-[var(--calendar-accent)] text-white font-semibold hover:bg-[var(--calendar-hover-accent)]',
          day_today:
            'border-2 border-[var(--calendar-accent)] text-[var(--calendar-accent)] font-bold', // Bolder today
