                    ...
                    >
                        ...
                        <div className="flex items-center mb-5">
                            ...
                            <div className="relative mr-4 flex-shrink-0">
                                ...
                                <div className="relative p-3 bg-gradient-to-br from-red-100 to-red-50 rounded-full 
                                shadow-sm group-hover:shadow-md transition-all duration-300">
                                    <ShieldAlert className="h-8 w-8 text-red-600/90" />
                                </div>

                                {/* Subtle pulse ring */}
                                <div className="absolute inset-0 rounded-full bg-red-400/10 animate-[ping_2.5s_ease-in-out_infinite] 
                                opacity-75" />
                            </div>
                        ...
                        <AlertDescription className="space-y-3 text-center">
                            ...
                            <p className="text-gray-600 text-md">
                                Vui lòng liên hệ <span className="text-red-600 font-medium hover:underline cursor-pointer">
                                    quản trị viên</span>
                                <br />nếu bạn cho rằng đây là sự nhầm lẫn
                            </p>
                        </AlertDescription>
