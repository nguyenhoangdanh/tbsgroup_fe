...
import { FormBlockInstance, FormBlockType, FormCategoryType, HandleBlurFunc, ObjectBlockType } from "@/@types/form-block.type";
import { ChevronDown, CircleIcon, Radio, X } from "lucide-react";
          ...
          return (
            <div key={index} className="flex items-center space-x-2">
              <RadioGroupItem
                value={option}
                id={uniqueId}
                className={`!cursor-pointer ${isError || isSubmitError ? "!border-red-500" : ""
                  }`}
              />
              <Label
                htmlFor={uniqueId}
  ...
  return (
    <div className="w-full pb-4">
      <div className="w-full flex items-center justify-between
            gap-1 bg-gray-100 h-auto p-1 px-2 mb-[10px]">
