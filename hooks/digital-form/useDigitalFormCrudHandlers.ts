...
export function useDigitalFormCrudHandlers({
  ...
  const handleUpdateForm = useCallback(
    async (id: string, data: TDigitalFormUpdate) => {
      try {
  ...
  const handleAddEntry = useCallback(
    async (formId: string, data: TDigitalFormEntry) => {
      try {
  ...
  const handleDeleteEntry = useCallback(
    async (formId: string, entryId: string) => {
      try {
  ...
  const handleRejectForm = useCallback(
    async (formId: string) => {
      try {
