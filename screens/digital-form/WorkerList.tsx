                ...
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <div className="font-bold flex items-center">
                      {worker.name}
                      <AttendanceBadge status={worker.attendanceStatus} className="ml-2" />
                    </div>
                ...
                <div className="mt-3 flex flex-wrap gap-1">
                  {isExpanded ? (
                    ...
                    <>
                      ...
                      {TIME_SLOTS.length > 6 && (
                        <button className="w-8 h-8 rounded-full bg-gray-100 text-gray-600 flex items-center justify-center text-xs hover:bg-gray-200">
                          +{TIME_SLOTS.length - 6}
                        </button>
                      )}
                    </>
