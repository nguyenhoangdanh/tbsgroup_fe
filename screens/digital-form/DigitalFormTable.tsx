...
import { useDigitalFormFilters, useDigitalFormPagination, useDigitalFormQueries } from "@/hooks/digital-form";
            ...
            <CardContent>
                ...
                <div className="space-y-4 mb-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {(filters.search || filters.status || filters.shiftType ||
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead className="w-[120px]" align="center">Thao tác</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                                ...
                                                <div className="flex justify-center">
                                                    <DropdownMenu>
                                                        ...
                                                        <DropdownMenuContent align="end">
                                                            ...
                                                            {(form.status === RecordStatus.DRAFT || form.status === RecordStatus.REJECTED) && (
                                                                <DropdownMenuItem
                                ...
                                <Pagination>
                                    <PaginationContent>
                                        <PaginationItem>
                                            <PaginationPrevious
                                                onClick={prevPage}
                                                className={!canPrevPage ? "pointer-events-none opacity-50" : "cursor-pointer"}
                                            />
                                        </PaginationItem>
