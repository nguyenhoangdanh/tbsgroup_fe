// components/digital-form/reports/summaries/GroupProductionSummary.tsx
'use client';

import { Card, CardContent } from '@/components/ui/card';

interface GroupProductionSummaryProps {
    report: {
        groupId: string;
        groupName: string;
        groupCode: string;
...
export function GroupProductionSummary({ report }: GroupProductionSummaryProps) {
    return (
        <Card>
            <CardContent className="pt-6">
                <div className="mb-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                        {report.teamName} | {report.lineName} | {report.dateRange.from} - {report.dateRange.to}
                    </p>
                </div>
