// components/digital-form/reports/summaries/LineProductionSummary.tsx
'use client';

import { Card, CardContent } from '@/components/ui/card';

interface LineProductionSummaryProps {
    report: {
        lineId: string;
        lineName: string;
        lineCode: string;
...
export function LineProductionSummary({ report }: LineProductionSummaryProps) {
    return (
        <Card>
            <CardContent className="pt-6">
                <div className="mb-6">
                    <h3 className="text-lg font-semibold">{report.lineName}</h3>
