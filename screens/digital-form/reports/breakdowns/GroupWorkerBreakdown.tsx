// components/digital-form/reports/breakdowns/GroupWorkerBreakdown.tsx
'use client';
                    ...
                    <TableBody>
                        {data.map(worker => {
                            const percentage = totalOutput > 0
                                ? Math.round((worker.totalOutput / totalOutput) * 100)
                                : 0;
                            ...
                            return (
                                <TableRow key={worker.userId}>
                                    ...
                                    <TableCell className="text-right">{worker.totalOutput.toLocaleString()}</TableCell>
                                    <TableCell>
                                    ...
                                    <TableCell className="text-right">
                                        <Badge
                                            variant={worker.efficiency >= 100 ? "success" : worker.efficiency >= 80 ? "default" : "destructive"}
                                        >
                                            {worker.efficiency}%
                                        </Badge>
                                    </TableCell>
