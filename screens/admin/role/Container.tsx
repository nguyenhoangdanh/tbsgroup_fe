...
const RoleManagementScreen = () => {
  ...
  // Dialog context
  const { updateDialogData } = useDialog();
  ...
  const handleRoleFormSubmit = useCallback(
    async (data: TRoleSchema): Promise<boolean> => {
  ...
  //   async (role: RoleType): Promise<boolean> => {
  ...
  const createForm = useMemo(() => {
    return <RoleForm onSubmit={handleRoleFormSubmit} />;
