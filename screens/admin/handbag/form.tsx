...
const HandBagForm: React.FC<HandBagFormProps> = memo(({
    onSubmit,
    refetchData,
}) => {
    ...
    // Khởi tạo form với giá trị mặc định hoặc dữ liệu từ dialog
    ...
    // Xử lý submit form
    const handleSubmit = useCallback(async (values: HandBagSchema) => {
        ...
        try {
            ...
            if (onSubmit) {
                ...
                // Nếu kết quả là true, đóng dialog
                if (result === true) {
                    hideDialog();
                }
            }
