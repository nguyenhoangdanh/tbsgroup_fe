...
// Define schema validation for the color
...
const BagColorForm: React.FC<BagColorFormProps> = memo(({
    onSubmit,
    refetchData,
    handBagId,
    handbags = [],
    ...
    const [isLoadingHandBags, setIsLoadingHandBags] = useState(false);
    ...
    const handleSubmit = useCallback(async (values: BagColorSchema) => {
            ...
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <FieldSelect
                        ...
                        options={handbags}
                        disabled={isSubmitting || isReadOnly || isLoadingHandBags || !!handBagId}
                        required
                    />
