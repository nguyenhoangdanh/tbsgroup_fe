...
const UserContainer = () => {
    ...
    // Update dialog when selected user changes
    useEffect(() => {
        if (selectedUser) {
    ...
    const handlePageChange = useCallback((pageIndex: number, pageSize: number) => {
        // pageIndex from TanStack Table starts at 0, API starts at 1
        ...
        setTimeout(() => refetchUsers(), 0);
    }, [updatePagination, refetchUsers, paginationMeta.currentPage, paginationMeta.pageSize]);
    ...
    }, [handleCreateUser, handleUpdateUser, refetchUsers, setSelectedUser]);
