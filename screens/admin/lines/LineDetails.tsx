import { ArrowLeft, Pencil, Users, Settings, Workflow, Trash2 } from 'lucide-react';
...
export const LineDetails: React.FC<LineDetailsProps> = ({ factoryId, lineId }) => {
  ...
  const handleRemoveManager = useCallback(
    (userId: string) => {
      ...
      const managerName =
        lineDetails.managers?.find(m => m.userId === userId)?.user?.fullName || userId;
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Nhà máy: {factory?.name || 'Đang tải...'}</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
        ...
        <Tabs defaultValue="general" className="w-full">
          ...
          <TabsContent value="general" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Thông tin chi tiết về dây chuyền {lineDetails?.name}
                </CardDescription>
              </CardHeader>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-medium">
                      {lineDetails?.capacity
                        ? `${lineDetails.capacity} sản phẩm/ngày`
                        : 'Chưa cập nhật'}
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="font-medium">
                      {lineDetails?.createdAt
                        ? new Date(lineDetails.createdAt).toLocaleString('vi-VN')
                        : 'N/A'}
                    </p>
                  </div>
                </div>
          ...
          <TabsContent value="teams" className="space-y-4">
            <LineTeamsTab factoryId={factoryId} lineId={lineId} canManage={!!canManage} />
          </TabsContent>
