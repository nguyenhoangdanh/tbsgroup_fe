...
export const LineSettings: React.FC<LineSettingsProps> = ({ factoryId, lineId }) => {
  ...
  //         description:
  //           error instanceof Error ? error.message : 'Đã xảy ra lỗi khi cập nhật trạng thái',
  //         variant: 'error',
  //         duration: 5000,
  //       });
  //     } finally {
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                {lineDetails?.name} ({lineDetails?.code}) - Nhà máy:{' '}
                {factory?.name || 'Đang tải...'}
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between py-4">
                    ...
                    <Button
                      variant="outline"
                      onClick={() =>
                        router.push(`/admin/factories/${factoryId}/lines/${lineId}/groups`)
                      }
                      disabled={!canManage || isPageLoading}
                    >
                      <Users className="mr-2 h-4 w-4" />
                  ...
                  <div className="flex items-center justify-between py-4">
                    ...
                    <Button
                      variant="outline"
                      onClick={() =>
                        router.push(`/admin/factories/${factoryId}/lines/${lineId}/workers`)
                      }
                      disabled={!canManage || isPageLoading}
                    >
                      <Users className="mr-2 h-4 w-4" />
