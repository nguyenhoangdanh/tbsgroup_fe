...
const ManagerForm: React.FC<ManagerFormProps> = ({
    ...
    const form = useForm<ManagerSchema>({
        ...
        defaultValues: mode === ManagerFormMode.CREATE
            ? {
                userId: "",
                isPrimary: false,
                startDate: new Date(),
    ...
    const handleSubmit = useCallback(async (values: ManagerSchema) => {
        ...
        try {
            ...
            await queryClient.invalidateQueries({
                predicate: (query) => {
                    return factoryCacheKeys.some(key =>
            ...
            toast({
                title: mode === ManagerFormMode.CREATE
                    ? "Lỗi thêm quản lý"
                    : "Lỗi cập nhật quản lý",
