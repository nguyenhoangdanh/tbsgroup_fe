...
import { Factory, FactoryWithDetails } from "@/common/interface/factory";

// Schema validation for factory
...
const FactoryForm: React.FC<FactoryFormProps> = memo(({
    onSubmit,
    refetchData,
    departments = []
}) => {
    ...
    // Filter departments by type for dropdown options
    ...
    const handleSubmit = useCallback(async (values: FactorySchema) => {
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
                ...
                */}
                ...
                {isReadOnly && hasDetailData && factoryDetails.managers && factoryDetails.managers.length > 0 && (
                    <div className="mt-6">
                                    ...
                                    <li key={manager.userId} className="flex items-center justify-between">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm text-muted-foreground">
                                                ...
                                                {manager.endDate && ` đến: ${new Date(manager.endDate).toLocaleDateString()}`}
                                            </span>
                                        </div>
                                    </li>
                                ))}
