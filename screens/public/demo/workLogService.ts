...
const mockOperations: Operation[] = [
  { code: 'OP001', name: 'May viền', hourlyTarget: 25 },
  { code: 'OP002', name: 'May dựng', hourlyTarget: 20 },
  { code: 'OP003', name: 'May đáy', hourlyTarget: 18 },
  { code: 'OP004', name: 'Lắp đai', hourlyTarget: 30 },
  { code: 'OP005', name: 'Hoàn thiện', hourlyTarget: 15 },
];

const workingTimeOptions = [
  { value: '8_hours', label: '8 tiếng (07:30 - 16:30)' },
  { value: '9.5_hours', label: '9 tiếng 30 phút (07:30 - 18:00)' },
  { value: '11_hours', label: '11 tiếng (07:30 - 19:00)' },
];
...
const getTimeSlotsForWorkingTime = (workingTime: string): string[] => {
  switch (workingTime) {
    ...
    case "11_hours":
      return ["7:30-8:30", "8:30-9:30", "9:30-10:30", "10:30-11:30", "12:30-13:30", "13:30-14:30", "14:30-15:30", "15:30-16:30", "17:00-18:00", "18:00-19:00"];
    default:
      return [];
  }
};
