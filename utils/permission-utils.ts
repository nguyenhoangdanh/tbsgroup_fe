...
import { NavItem, Project } from "../components/common/layouts/admin/sidebar/_components/sidebar-data";
 ...
 */
export function hasRouteAccess(route: string, userRole: UserRole, permissions: PermissionConfig = defaultPermissions): boolean {
