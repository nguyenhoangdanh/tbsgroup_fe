  ...
  return (
    <div
      ...
      <div className="w-full h-full max-w-[650px] mx-auto">
        <div className="w-full relative bg-transparent px-2flex flex-col items-center justify-start pt-1 pb-14">
          ...
          <div className="w-full h-auto">
            {isSubmitted ? (
              <Card className="w-full bg-white bordershadow-sm min-h-[120px] rounded-md !p-0">
