...
import FormBlockSetting from './FormBlockSetting'
import { useBuilder } from '@/context/builder-provider'
type TTab = "blocks" | "settings";
const BuilderSidebar = ({
    ...
    const [tab, setTab] = React.useState<TTab>('blocks');
    ...
    return (
        <Sidebar className='border-r left-12 pt-16' {...rest}>
            <SidebarHeader className='bg-white px-0'>
                <header className='border-b  border-gray-200 w-full pt-1 pb-2 flex shrink-0 items-center gap-2'>
                    <div className="flex item-center gap-2 px-4">
                        ...
                        <Separator orientation='vertical' className='mr02 h-4' />
                        <Breadcrumb>
                            <BreadcrumbList>
            ...
            <SidebarContent className='pt-2 bg-white px-5'>
