...
const PreviewDialog = () => {
  ...
  return (
    <Dialog>
      ...
      <DialogContent
        className="flex flex-col flex-grow max-h-svh h-full p-0 gap-0 w-screen max-w-full">
        ...
        >
          <div className="w-full h-full max-w-[650px] mx-auto">
            <div
              className="w-full relative bg-transparent px-2flex flex-col
                    items-center justify-start pt-1 pb-14">
              <div
