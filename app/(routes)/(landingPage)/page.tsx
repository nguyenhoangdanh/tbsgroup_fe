        ...
        <div className="w-full flex flex-col items-center justify-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col mt-5 items-center text-center">
            ...
            <p className=" block text-lg mt-3 max-w-2xl mx-auto w-full font-medium ">
              Các giá trị cốt lõi, cấu trúc doanh nghiệp, cột mốc, thành tựu và đóng góp to lớn của
              nhà điều hành là tiền đề, động lực cho sự phát triển chung cho một tương lai vững mạnh
              của TBS.
            </p>
            <br />
            <div className="w-full flex flex-col md:flex-row gap-4 items-center justify-between">
              <img
                src="https://www.tbsgroup.vn/wp-content/uploads/2014/12/about-landing-image-1.png"
                alt="about-landing-image-1"
              ></img>
              <div className="w-full flex flex-col gap-2 items-start">
                ...
                <p>
                  TBS đầu tư và phát triển 6 lĩnh vực chính, bao gồm: Da giày, Túi xách, Đầu tư và
                  quản lí Bất động sản và Hạ tầng công nghiệp, Cảng &amp; Logistics, Thương mại
                  &amp; Dịch vụ. Mỗi ngành nghề đều có những thành tích, thành công đáng kể góp phần
                  quan trọng vào sự phát triển vững mạnh của công ty.
                </p>
              </div>
            </div>
